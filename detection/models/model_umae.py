...
class Model3DETR(nn.Module):
    ...
    def get_query_embeddings(self, encoder_xyz, point_cloud_dims):
        ...
        query_embed = self.query_projection(pos_embed)  #  torch.Size([8, 256, 256])
    ...
    def run_encoder(self, point_clouds):
        ...
        pre_enc_xyz, pre_enc_features, pre_enc_inds = self.pre_encoder(xyz, features)  # embedding
        ...
        enc_xyz, enc_features, enc_inds = self.encoder(  # xyz, output, None
...
def build_umae(args, dataset_config):
