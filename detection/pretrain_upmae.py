...
from datasets import build_dataset, build_self_dataset
from engine import evaluate, train_one_epoch, train_simple_one_epoch
...
def make_args_parser():
    ...
    ##### Dataset #####
    parser.add_argument(
        "--dataset_name", default="upmaescannet", type=str, choices=["scannet", "sunrgbd", "selfscannet","upmaescannet"]
    )
    parser.add_argument(
        "--dataset_root_dir",
        type=str,
    ...
    parser.add_argument("--max_epoch", default=301, type=int)
    parser.add_argument("--eval_every_epoch", default=100, type=int)
    ...
    ##### I/O #####
    parser.add_argument("--checkpoint_dir", default="./checkpoint_upmae1024", type=str)
...
def main(local_rank, args):
    ...
    datasets, dataset_config = build_self_dataset(args)
