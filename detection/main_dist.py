...
def make_args_parser():
    ...
    parser.add_argument(
        ...
        choices=["3detr","umae_3detr","up_mae_3detr","umae"],
    )
    ### Encoder
    parser.add_argument(
    ...
    ##### Dataset #####
    parser.add_argument(
        "--dataset_name", required=True, type=str, choices=["scannet", "sunrgbd", "selfscannet"]
    )
    parser.add_argument(
        "--dataset_root_dir",
        type=str,
...
def main(local_rank, args):
    ...
    if args.test_ckpt:
        model.load_model_from_ckpt(args.test_ckpt)
