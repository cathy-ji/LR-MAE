...
DATA_PATH_V1 = "/sunrgbd/sunrgbd_trainval/sunrgbd_pc_bbox_votes_50k_v1" ## Replace with path to dataset
    ...
    def __init__(
        ...
        if split_set in ["train", "val"]:
            ...
            for sub_split in sub_splits:
                data_path = root_dir + "_%s" % (sub_split)
                basenames = sorted(
...
class UPmaeSunrgbdDetectionDataset(Dataset):
    def __init__(
        self,
        dataset_config,
        split_set="train",
