...
def parse_function(*metrics, directory='', args=None, end_signal=None):
    ...
    for file_dir in file_list:
        file_list1 = os.listdir(osp.join(directory,file_dir))
        for file in file_list1:
            if 'log' in file or 'pt.txt' in file:
                num = 0
                fpath = osp.join(directory, file_dir,file)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--directory', type=str, default='experiments/finetune_scan_objbg/', help='path to directory')
    parser.add_argument(
        '--ci95',
        action='store_true',
